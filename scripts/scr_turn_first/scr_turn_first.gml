	...
	if (peace_check>0){
	    ...
	    if (peace_check=2){
	        ...
	        if (did_so=false) and (faction_defeated[7]=1){
	            ...
	            faction_defeated[7]=-1;known[eFACTION.Ork]=1;faction_leader[eFACTION.Ork]=global.name_generator.generate_ork_name(); // known used to be 0, which made new warbosses uninteractable diplomatically
