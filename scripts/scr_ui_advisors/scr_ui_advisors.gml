function scr_ui_advisors() {
    ...
    if (menu = 15) {
        ...
        if (recruit_trial = "Hunting the Hunter") {
            blurp3 = "-Planet Bonus': Desert, Ice, Death, Feudal#-Up to 15 bonus XP on Neophytes";
        ...
        if (recruit_trial = "Survival of the Fittest") {
            blurp3 = "-Planet Bonus': Desert, Ice, Death, Lava#-(+10-30% recruits)";
        ...
        if (recruit_trial = "Knowledge of Self") {
            blurp3 = "-Planet Bonus: Temperate, Shrine (up to 10 bonus xp)#-1.5-3 Years longer training#-Up to bonus 25 XP on Neophytes.";
        ...
        if (recruit_trial = "Apprenticeship") {
            blurp3 = "-Planet Bonus: Feudal (+10-50% recruits)#-4-5 Years longer training time#-Almost able for immediate promotion";
