...
function scr_ui_advisors() {
    ...
    // ** Armamentarium **
        ...
        if (recruit_trial = "Hunting the Hunter") {
            blurp3 = "- 6 years of training.#- 7-20 starting XP on Desert, Ice, Death and Feudal worlds";
        ...
        if (recruit_trial = "Survival of the Fittest") {
            blurp3 = "- 6 years of training.#- 10-30% more recruits on Desert, Ice, Death and Lava worlds.";
        ...
        if (recruit_trial = "Knowledge of Self") {
            blurp3 = "- 7.5-9 years of training.#- 15-25 starting XP.#- Additional 5-10 starting XP on Temperate and Shrine worlds.";
        ...
        if (recruit_trial = "Apprenticeship") {
            blurp3 = "- 10-11 years of training.#- 34+ starting XP.#- 30-50% more recruits on Feudal worlds.";
