            ...
            if (instance_exists(thata)){
                ...
                if (good>0){
                    repeat(10){
                        ...
                        thata.marine_wep1[ii]="Power Axe";thata.marine_wep2[ii]="Conversion Beam Projector";
                        thata.marine_armour[ii]="Dragon Scales";thata.marine_gear[ii]="Servo Arms"; thata.marine_mobi[ii]="";
                    ...
                    repeat(20){
                        ...
                        thata.marine_wep1[ii]="Hellgun";thata.marine_wep2[ii]="Combat Knife";
