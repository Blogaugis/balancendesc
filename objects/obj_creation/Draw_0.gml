...
if (slide=3){
    ...
    if (aspirant_trial="Hunting the Hunter") then asp_info="- 6 years of training.#- 7-20 starting XP on Desert, Ice, Death and Feudal worlds";
    if (aspirant_trial="Survival of the Fittest") then asp_info="- 6 years of training.#- 10-30% more recruits on Desert, Ice, Death and Lava worlds.";
    if (aspirant_trial="Exposure") then asp_info="- 3-5 years of training on Desert, Ice, Forge, Lava and Death worlds.#- 6 years of training on all other worlds.";
    if (aspirant_trial="Knowledge of Self") then asp_info="- 7.5-9 years of training.#- 15-25 starting XP.#- Additional 5-10 starting XP on Temperate and Shrine worlds.";
    if (aspirant_trial="Challenge") then asp_info="- 5.5-6.5 years of training.#- 20% chance to gain 10-20 starting XP.";
    if (aspirant_trial="Apprenticeship") then asp_info="- 10-11 years of training.#- 34+ starting XP.#- 30-50% more recruits on Feudal worlds.";
