...
if((file_exists("chaptersave#1.ini")=true) and (chapter_made=1)){
	...
	icon21= ini_read_real("Save","icon#",icon);
	   ...
	   stability21= ini_read_real("Save","stability",stability);
		...
		homeworld21 = ini_read_string("Save","homeworld","Death");
		homeworld_name21 = ini_read_string("Save","homeworld_name","Barbaras");
		 recruiting_world21= ini_read_string("Save","recruiting","Temperate");
		recruiting_name21 = ini_read_string("Save","recruiting_name","Vargus");
		homeworld_exists21 = ini_read_real("Save","home_worldexists",1);
		recruiting_exists21= ini_read_real("Save","recruiting_exists",1);
		homeworld_rule21= ini_read_real("Save","home_world_rule",1);
		aspirant_trial21=ini_read_string("Save","aspirant_trial","Blood Duel");
		flagship_name21= ini_read_string("Save","flagship_name","Emperor's Retribution");
		discipline21= ini_read_string("Save","discipline","default");
...
strength21=2;
 ...
 cooperation21=2;
 homeworld21="Death"
 homeworld_name21="Barbarus"
 recruiting_world21="Temperate"
recruiting_name21="Vartus"
...
color_to_pauldron21="Red"; 
		 ...
		 master_name21="SHH";
		 fleet_type21=1
		 flagship_name21="Emperor's Retribution"
		 discipline21="default"
