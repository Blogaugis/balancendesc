...
if (did==1){
    ...
    current_system.p_type[1]="Lava";
    current_system.p_type[2]="Forge";
	/*
	...
	*/
    ...
    with(current_system){// with current_system
        ...
        for(var i=0; i<10; i++){
            ...
            e = p_type[3]; // Earth, so Temperate and Agri worlds and other hi-pop worlds should be plentiful
            switch (e) {
                case "Lava":
                    c = 1;
                    break;
            ...
            switch (e) {
                ...
                case "Dead":
                    ...
                    break;
                case "Forge":
                    d = 2; // Mars is the 4th planet in our Solar system
                    break;
            }
